...
from extractor.assets.historical_data_resources import (
    HistoricalDataResources as hist_dr,
)
...
dict_assets = {}
dict_assets["crypto_data_extraction_pipeline"] = [
    "USDT",
    "BTC",
    "ETH",
    "USDC",
...
dict_assets["index_data_extraction_pipeline"] = [
    "^GSPC",
    "^IXIC",
    "^DJI",
    "^N225",
...
dict_assets["bond_data_extraction_pipeline"] = [
    "SHY",
    "BIL",
    "BLV",
    "TLT",
...
dict_assets["commodity_data_extraction_pipeline"] = [
    "CL",
    "NG",
    "GC",
    "ZS",
...
dict_assets["currency_data_extraction_pipeline"] = [
    "GBPUSD=X",
    "GBPEUR=X",
    "JPY=X",
    "EUR=X",
...
for key in dict_assets.keys():
    ...
    res_historical_data = hist_dr.get_historical_data(
        names=tickers,
        period="max",
    ...
    res_info_data = info_dr.get_info_data(
        names=tickers,
        period="max",
        updated_at=updated_at,
        updated_by=updated_by,
    ...
    res_analyst_price_targets = analysts_dr.get_analyst_price_targets(
        names=tickers, updated_at=updated_at, updated_by=updated_by, batch_id=batch_id
    )
    res_news = news_data_dr.get_news_data(
        names=tickers, updated_at=updated_at, updated_by=updated_by, batch_id=batch_id
    )
    res_recommendations = recommendations_data_dr.get_recommendations_data(
        names=tickers, updated_at=updated_at, updated_by=updated_by, batch_id=batch_id
    )
